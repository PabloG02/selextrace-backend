...
public interface ProjectMembershipRepository extends JpaRepository<ProjectMembershipRecord, Long> {
    ...
    List<ProjectMembershipRecord> findAllByProject_Id(String projectId);

    @EntityGraph(attributePaths = "project")
    List<ProjectMembershipRecord> findAllByUser_Id(String userId);

    Optional<ProjectMembershipRecord> findByProject_IdAndUser_Id(String projectId, String userId);
